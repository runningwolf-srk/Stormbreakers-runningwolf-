...
export default function HomePage() {
  ...
  const doors = [
    { icon: "⚔️", title: "Hall of Relics", subtitle: "Songs", href: "/music", rune: "H", desc: "Where worship meets war" },
    { icon: "📖", title: "The Chronicle", subtitle: "Story", href: "/chronicle", rune: "K", desc: "Testimony forged in storm" },
    { icon: "✝️", title: "The Word", subtitle: "Scripture", href: "/word", rune: "O", desc: "The King is the center" },
    { icon: "📚", title: "The Library", subtitle: "Books", href: "/library", rune: "L", desc: "Pages bound in leather" },
  ];

  return (
    <main className="relative min-h-screen bg-[#0a0a0a] text-zinc-100 overflow-hidden">
      <div className="fixed inset-0 pointer-events-none">
        <div className="absolute bottom-0 left-0 right-0 h-[40vh] bg-gradient-to-t from-black via-zinc-900/50 to-transparent"></div>
        ...
        <div className="max-w-7xl mx-auto w-full grid lg:grid-cols-[1.1fr_0.9fr] gap-12 items-center">
          <div className="relative flex flex-col items-center">
            <div className="relative p-3 bg-gradient-to-br from-amber-900/40 via-zinc-800 to-amber-900/40 rounded-sm shadow-2xl">
              <div className="relative bg-black p-2">
                <img src={avatarFile} alt="RunningWolf" className="w-[340px] md:w-[420px] h-auto object-cover block" />
          ...
          <div className="text-center lg:text-left">
            <div className="mb-8">
              ...
              <p className="mt-4 text-zinc-400 tracking-widest text-sm">Viking Christian Music - Chronicles - Scripture</p>
            </div>
      ...
      <section className="relative z-10 px-8 md:px-20 pb-20">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {doors.map((door) => (
              <Link key={door.title} href={door.href} className="group relative bg-[#121212] border border-zinc-800 hover:border-amber-700/50 p-8 transition-all duration-300 hover:-translate-y-1">
          ...
          <div className="mt-16 text-center border-t border-amber-900/20 pt-8">
            <p className="font-serif italic text-zinc-500">Viking is the binding. Scripture is the pages. The King is the center.</p>
