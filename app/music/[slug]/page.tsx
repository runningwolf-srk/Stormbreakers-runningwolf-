...
export default function RelicPage({ params }: { params: { slug: string } }) {
  ...
  const handleVoiceChange = (voiceName: string) => {
    ...
    localStorage.setItem('relic-voice', voiceName);
  };
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          ...
          >
            <button
              ...
              className="bg-amber-600 hover:bg-amber-500 text-black font-black py-4 px-12 rounded-lg transition-all hover:scale-105 shadow-2xl shadow-amber-600/40 text-lg tracking-wider w-full sm:w-auto"
            >
              ENTER STORY MODE
            </button>
          </motion.div>
          ...
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            <div className="bg-zinc-900/50 border border-zinc-800 rounded-xl p-6 md:p-8">
              ...
              <select
                ...
                className="w-full bg-zinc-950 border border-zinc-800 text-zinc-300 text-sm rounded-lg p-3 mb-4 focus:border-amber-600 outline-none"
              >
              ...
              <div className="grid grid-cols-2 gap-3">
                <button
                  ...
                  className="bg-zinc-800 hover:bg-amber-600 text-white hover:text-black font-bold py-4 px-4 rounded-lg transition-all"
                >
                  {isNarrating? "■ STOP" : "▶ PLAY"}
                </button>
                <button
                  onClick={pauseResumeNarration}
                  disabled={!isNarrating}
                  className="bg-zinc-800 hover:bg-zinc-700 text-white font-bold py-4 px-4 rounded-lg transition-all disabled:opacity-30 disabled:cursor-not-allowed"
                >
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            <div className="border-l-4 border-amber-500 pl-6 md:pl-8 text-left">
              <p className="text-2xl md:text-4xl italic text-zinc-200 leadi
