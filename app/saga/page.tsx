  ...
  return (
    <div style={{ background:'#000', color:'#fff', minHeight:'100vh', padding:'60px 24px', fontFamily:'Georgia, serif' }}>
      <div style={{ maxWidth:'700px', margin:'0 auto' }}>
        <div style={{ fontSize:'12px', letterSpacing:'4px', color:'#d4af37', marginBottom:'40px', fontFamily:'system-ui, sans-serif' }}>
          THE TESTIMONY
        </div>
        <h1 style={{ fontSize:'48px', color:'#d4af37', margin:'0 0 60px 0', letterSpacing:'3px' }}>
          THE SAGA
        </h1>
