export function RelicIcon({ symbol, className = "w-8 h-8" }: { symbol: string, className?: string }) {
  const map: any = {
    ...
    "lion": (<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" className={className}><circle cx="12" cy="12" r="8"/><path d="M9 9h.01M15 9h.01"/></svg>),
    "wheat": (<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" className={className}><path d="M12 2v20M12 6c0-2 2-3 4-3M12 8c0-2-2-3-4-3"/></svg>),
    "altar-2": (<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" className={className}><path d="M4 20h16M8 12h8M8 8h8"/></svg>),
    "storm": (<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" className={className}><path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"/></svg>),
    "anchor": (<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" className={className}><circle cx="12" cy="5" r="3"/><path d="M12 8v12M7 14a5 5 0 0010 0"/></svg>),
