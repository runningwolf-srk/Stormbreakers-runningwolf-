...
<p className="text-xs tracking-[0.3em] text-zinc-400">ONE CANON • FOUR EXPERIENCES • SIXTEEN RELICS • ONE KING</p>
<p className="text-xs tracking-[0.3em] text-zinc-500">⚔️ FORGED: {CANON_PROGRESS.forged}/16 • 🔥 IN PROGRESS: {CANON_PROGRESS.inProgress}/16 • 🔒 UNREVEALED: {CANON_PROGRESS.unrevealed}/16</p>
