    ...
    <div style={{background:'#050507', color:'#e8e0c8', minHeight:'100vh'}}>
      <div style={{width:'100%', maxWidth:640, margin:'0 auto', background:'#000', borderRadius:'0 0 14px 14px', overflow:'hidden'}}>
        <div style={{width:'100%', position:'relative'}}>
          <img src="/763847743_1664822977910376_5098702148838621819_n-1.webp" style={{width:'100%', height:'auto', display:'block'}} alt="Stormbreakers" />
          <div style={{position:'absolute', bottom:0, left:0, right:0, height:80, background:'linear-gradient(to top, #050507, rgba(0,0,0,0))'}}></div>
        </div>
      </div>
