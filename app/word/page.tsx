  ...
  return (
    <div className="min-h-screen bg-[#040404] text-zinc-100 px-6 py-20">
      <div className="max-w-3xl mx-auto text-center">
        ...
        <p className="text-zinc-500 text-sm mt-3 leading-relaxed max-w-xl mx-auto">Scripture anchors everything.<br/><span className="text-zinc-300">The relics become more than entertainment — they become discoveries rooted in truth.</span></p>
        ...
        <div className="mt-12 border border-amber-900/15 rounded-xl p-6 bg-zinc-900/20 max-w-sm mx-auto">
          ...
          <div className="flex flex-col items-center gap-1 text-[11px] tracking-widest text-zinc-500">
            <span>Scripture</span><span className="text-zinc-700">↓</span><span>Meaning</span><span className="text-zinc-700">↓</span><span>Context</span><span className="text-zinc-700">↓</span><span>Application</span><span className="text-zinc-700">↓</span><span>Reflection</span>
          </div>
        </div>
