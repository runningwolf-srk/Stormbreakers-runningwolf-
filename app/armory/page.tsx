  ...
  return (
    <main className="min-h-screen bg-black text-white p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto">
        {RELICS.map(relic => (
          <div key={relic.id} className="border border-amber-600/30 p-4 hover:border-amber-600 transition">
            <img src={relic.image} alt={relic.title} className="w-full h-64 object-cover mb-4" />
