// app/page.tsx - FINAL 100% Perfect Pre-Music Launch
    ...
    <main className="min-h-screen bg-[#0a0a0a] text-amber-50 flex flex-col items-center px-5 pt-12 pb-12 overflow-x-hidden">
      ...
      <div className="relative z-10 w-full max-w-5xl flex flex-col items-center text-center">
        ...
        <div className="w-full p-6 rounded-xl bg-stone-900/50 border border-amber-400/10 mb-16 text-center">
          <p className="text-amber-400/50 text-[10px] tracking-[0.3em] font-black mb-4">THE WORD</p>
        ...
        <div className="w-full text-center">
          ...
          <div className="p-6 rounded-xl bg-gradient-to-br from-amber-500/10 to-stone-900 border border-amber-400/15">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Link href="/armory" className="px-8 py-3 bg-amber-500 text-stone-950 font-black rounded-xl text-sm text-center">⚔️ Enter The Armory</Link>
              <Link href="/chronicles" className="px-8 py-3 bg-stone-900 border border-amber-400/20 text-amber-400 font-black rounded-xl text-sm text-center">📖 Read The Chronicles</Link>
              <Link href="/word" className="px-8 py-3 bg-transparent border border-amber-400/10 text-amber-200/60 font-black rounded-xl text-sm text-center">✝️ Study The Word</Link>
            </div>
          </div>
        </div>
