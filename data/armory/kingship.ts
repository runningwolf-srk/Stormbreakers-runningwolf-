...
export const kingshipRelics: Relic[] = [
  {
    ...
    relic: "Royal Relic",
    song: "Royal Relic",
    scripture: "But you are a chosen race, a royal priesthood, a holy nation, a people for his own possession",
    reference: "1 Peter 2:9 ESV",
    primaryTheme: "Kingship",
    themes: ["Kingship", "Identity", "Authority", "Calling"],
    declaration: "I am royalty. Not by blood, but by Blood. Chosen. Holy. Set apart for His possession.",
