// data/relics.ts — V1.2 FINAL HOTFIX — AUDIOURL ADDED
export type Relic = {
  id: string;
  title: string;
  image: string;
  audio: string;        // ← keep for old code
  audioUrl: string;     // ← ADDED: what AudioEngine actually wants
  ambientUrl?: string; 
  scripture: string;
  ref: string;
  declaration: string;
...
export const RELICS: Relic[] = [
  {
    ...
    audioUrl: "/audio/running-wolfs-blade.mp3", // ← ADDED
  ...
  },
  {
    ...
    audioUrl: "/audio/thunder-drum.mp3", // ← ADDED
  ...
  },
  {
    ...
    audioUrl: "/audio/eternal-fire.mp3", // ← ADDED
  ...
  },
  {
    ...
    audioUrl: "/audio/chronicle-stone.mp3", // ← ADDED
  ...
  },
  {
    ...
    audioUrl: "/audio/the-first-flame.mp3", // ← ADDED
  ...
  },
  {
    ...
    audioUrl: "/audio/wolfs-fang.mp3", // ← ADDED
  ...
  },
  {
    ...
    audioUrl: "/audio/spirit-mantle.mp3", // ← ADDED
  ...
  },
  {
    ...
    audioUrl: "/audio/storm-crown.mp3", // ← ADDED
