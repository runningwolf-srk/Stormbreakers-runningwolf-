...
import { chronicles } from '@/data/chronicles' // ← exports your chapters array

export default function TheWordPage() {
  return (
    <main className="min-h-screen bg-black text-white p-6">
      <h1 className="text-4xl font-bold text-amber-400 mb-8">The Word</h1>
      
      <div className="grid gap-6">
        {allScriptures.map((verse) => (
          <div key={verse.slug} className="bg-zinc-900 p-6 rounded-lg border border-zinc-800">
