...
<div className="mt-5 max-w-xl mx-auto text-[13px] leading-relaxed text-white/60 italic">
The warrior has received the Word.<br/>
He has bowed before the King.<br/>
He has been redeemed by the Cross.<br/>
<span className="text-white font-bold not-italic mt-3 block">Now he must walk through the wilderness, face the shadow, and keep the oath.</span>
</div>
