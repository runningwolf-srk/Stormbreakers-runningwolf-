...
export default function HomePage() {
  const featuredRelic = armory[0] // Jesus Is An Healer
      ...
      <section className="relative py-20 px-4 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-amber-100/60 max-w-2xl mx-auto mb-12">
            16 relics. One mission. Every song anchored in Scripture,
      ...
      <section className="py-16 px-4">
        <div className="max-w-5xl mx-auto grid md:grid-cols-3 gap-8 text-center">
          <div>
            ...
            <p className="text-amber-100/70">The Scriptures that form the foundation of every Stormbreakers relic.</p>
          </div>
          <div>
            <div className="text-4xl mb-4">📖</div>
            <h3 className="text-xl font-bold text-amber-400 mb-2">The Chronicles</h3>
            <p className="text-amber-100/70">The testimony behind each song. Stories forged in fire.</p>
          </div>
          <div>
            <div className="text-4xl mb-4">🎵</div>
            <h3 className="text-xl font-bold text-amber-400 mb-2">The Armory</h3>
            <p className="text-amber-100/70">Experience the music. Declarations. Worship.</p>
          </div>
        </div>
      </section>
