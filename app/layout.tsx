...
<Link href="/armory" className="text-xs tracking-[0.25em] text-zinc-400 hover:text-white py-2">ARMORY</Link>
<Link href="/chronicles" className="text-xs tracking-[0.25em] text-zinc-400 hover:text-white py-2">CHRONICLES</Link>
<Link href="/word" className="text-xs tracking-[0.25em] text-zinc-400 hover:text-white py-2">WORD</Link>
<Link href="/books" className="text-xs tracking-[0.25em] text-zinc-400 hover:text-white py-2">BOOKS</Link>
</nav></div></header>
