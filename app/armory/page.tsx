  ...
  return (
    <div className="px-6 py-12">
      <div className="max-w-3xl mx-auto border border-zinc-800 rounded-xl p-8 mb-12 text-center">
        ...
        <div className="w-full h-1 bg-zinc-900 mt-4 rounded overflow-hidden"><div className="h-1 bg-white rounded" style={{width:`${(CANON_PROGRESS.forged/16)*100}%`}}/></div>
      </div>
      <div className="grid gap-6 max-w-3xl mx-auto">
        {ALL_RELICS.map(r=>(
          <Link key={r.slug} href={`/armory/${r.slug}`} className="border border-zinc-800 rounded-xl p-8 hover:border-zinc-600 transition">
            ...
            <h2 className="text-2xl font-black tracking-widest mt-2">{r.title.toUpperCase()}</h2>
