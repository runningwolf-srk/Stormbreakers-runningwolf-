...
export const RELICS: Relic[] = [
  { 
    id: 'first-flame', slug: 'first-flame', title: 'The First Flame', image: '/first-flame.jpg',
  ...
  { 
    id: 'pillar-fire', slug: 'pillar-fire', title: 'Pillar of Fire', image: '/pillar-fire.png',
  ...
  { 
    id: 'crown-storm', slug: 'crown-storm', title: 'Crown of the Storm', image: '/crown-storm.png',
  ...
  { 
    id: 'amulet-wolf', slug: 'amulet-wolf', title: 'Wolf Amulet', image: '/runningwolfs-blade.png',
  ...
  { 
    id: 'stone-tablet', slug: 'stone-tablet', title: 'The Tablet', image: '/stone-tablet.png',
  ...
  { 
    id: 'mantle-fire', slug: 'mantle-fire', title: 'The Mantle', image: '/mantle-fire.png',
  ...
  { 
    id: 'anvil-storm', slug: 'anvil-storm', title: 'The Anvil', image: '/anvil-storm.png',
  ...
  { 
    id: 'flaming-cross', slug: 'flaming-cross', title: 'Cross of Fire', image: '/runningwolf-avatar.jpg',
