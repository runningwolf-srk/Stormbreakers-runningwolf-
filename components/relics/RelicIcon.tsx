export function RelicIcon({ symbol, className = "w-8 h-8" }: { symbol: string, className?: string }) {
  const m: any = {
    "map-scroll": <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" className={className}><path d="M6 3h9l3 3v15H6z"/></svg>,
    ...
    "tower-babel": <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" className={className}><path d="M6 20h12M7 20V8l5-4 5 4v12M8 12h8M8 16h8"/></svg>,
