  ...
  return (
    <main className="min-h-screen bg-stone-950 text-amber-50 px-4 py-12">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="p-6 bg-amber-500/5 border border-amber-400/20 rounded-xl mb-6"><p className="text-amber-400/50 text-xs tracking-[0.3em] font-black">SCRIPTURE</p><p className="text-amber-300 font-bold mt-2">{r.ref}</p><p className="text-amber-100 italic mt-3 text-lg leading-relaxed">"{r.verse}"</p><p className="text-amber-200/20 text-xs mt-4">Full verse — {r.ref} (ESV) — excerpt used intentionally</p></div>
