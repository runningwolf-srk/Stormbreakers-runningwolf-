        ...
        <div className="mt-12 bg-[#0a0a0a] border border-amber-900/20 p-8">
          ...
          <div className="mt-8 grid md:grid-cols-2 gap-4">
            <div className="bg-black border border-zinc-800 p-4 text-center opacity-40">
              ...
              <p className="text-[11px] text-zinc-700 mt-1">Future revelations — Sealed until the next page is revealed</p>
            </div>
            <div className="bg-[#0f0f0f] border border-amber-900/20 p-4 text-center">
              <p className="text-[10px] tracking-widest text-amber-700/50">FOUR DOORS PHILOSOPHY</p>
              <p className="text-[11px] text-zinc-500 mt-1">Hear it (Relics) → Understand it (Chronicle) → Root it (Word) → Go deeper (Library)</p>
            </div>
          </div>
        </div>
