...
const DATA:any={
"runningwolf-blade":{
num:"I",title:"RUNNINGWOLF BLADE",icon:"⚔️",
...
"lord-of-lords":{
num:"II",title:"LORD OF LORDS",icon:"👑",
...
"blood-of-cross":{
num:"III",title:"BLOOD OF CROSS",icon:"✝️",
...
if(!r) return(<div className="min-h-screen bg-black text-white flex items-center justify-center p-10 text-center"><div><div className="text-5xl">🔒</div><div className="mt-6 font-black tracking-widest">RELIC {String(slug).toUpperCase()}</div><div className="mt-2 text-white/40 text-sm">THE NEXT CHAPTER HAS NOT BEEN FORGED</div><div className="mt-3 text-[10px] font-mono text-white/20">SYMBOL:?? — AWAITING REVELATION</div><a href="/" className="mt-8 inline-block border border-white/10 rounded-full px-6 py-3 text-xs">← RETURN TO FORGE</a></div></div>)
return(
...
<div className="flex justify-between"><div className="text-[10px] font-mono text-white/30">RELIC {r.num} • CHAPTER I</div><div className="text-[9px] font-mono px-2.5 py-1 rounded-full bg-white/10">FORGED</div></div>
...
<div className="px-6 pb-8"><div className="aspect-video bg-black border border-white/10 rounded-2xl flex items-center justify-center text-white/20 text-xs font-mono">▶ VIDEO FORGING — COMING SOON</div></div>
</div>
