...
export const warfareRelics: Relic[] = [
  {
    ...
    relic: "Thunder Drums",
    song: "Thunder Drums",
    scripture: "The Lord will march out like a champion, like a warrior he will stir up his zeal; with a shout he will raise the battle cry and will triumph over his enemies",
    reference: "Isaiah 42:13 NIV",
    primaryTheme: "Warfare",
    themes: ["Warfare", "Storm", "Authority", "Calling", "Victory"],
    declaration: "I march to the sound of heaven's drums. The storm is my cover. The thunder is His voice. I advance, not retreat.",
