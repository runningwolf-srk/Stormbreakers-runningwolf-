  ...
  return (
    <main style={{minHeight:'100vh',background:'#0a0a0a',color:'#f5f5dc',display:'flex',alignItems:'center',justifyContent:'center',padding:40,fontFamily:'serif',textAlign:'center'}}>
      <div style={{maxWidth:540,width:'100%'}}>
        ...
        <p style={{marginTop:18,opacity:0.65,lineHeight:1.8}}>
          This path is still being forged.<br/>
          The song is not written. The chapter is not opened.<br/>
          The walk is waiting.
        </p>

        <Link href="/armory" style={{display:'block',marginTop:32,padding:'18px 20px',background:'#f5f5dc',color:'#0a0a0a',textDecoration:'none',fontWeight:900,letterSpacing:2,fontSize:13}}>
          ⚔️ RETURN TO ARMORY
        </Link>
        ...
        <div style={{marginTop:10,display:'grid',gridTemplateColumns:'1fr 1fr',gap:8}}>
          ...
          <Link href="/" style={{border:'1px solid #222',padding:'12px 10px',color:'#888',textDecoration:'none',background:'#111',fontSize:13}}>🏰 Hear — Journey</Link>
        </div>
