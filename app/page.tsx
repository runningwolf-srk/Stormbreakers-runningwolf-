    ...
    <div style={{background:'#050507', color:'#e8e0c8', minHeight:'100vh'}}>
      ...
      <div style={{maxWidth:640, margin:'0 auto', padding:'10px 18px 20px', textAlign:'center'}}>
        ...
        <div style={{marginTop:14, display:'grid', gap:7}}>
          <a href="/music" style={{display:'block', padding:11, background:'#141210', border:'1px solid #2a2318', borderRadius:11, color:'#e8e0c8', textDecoration:'none', fontSize:11}}>HALL OF RELICS</a>
          <a href="/word" style={{display:'block', padding:11, background:'#141210', border:'1px solid #2a2318', borderRadius:11, color:'#e8e0c8', textDecoration:'none', fontSize:11}}>THE WORD — LIVE NOW</a>
