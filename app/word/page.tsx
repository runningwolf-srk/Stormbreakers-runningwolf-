  ...
  return (
    <div className="min-h-screen bg-[#040404] text-zinc-100 px-6 py-20">
      <div className="max-w-3xl mx-auto text-center">
        ...
        <p className="text-zinc-500 text-sm mt-3 leading-relaxed">Scripture anchors everything.<br/>Prevents the relics from becoming just entertainment.</p>
        ...
        <div className="mt-12 text-left grid gap-3">
          ...
          <div className="border border-zinc-800 p-5 rounded-lg"><p className="text-xs font-bold">Revelation 19:16</p><p className="text-[11px] text-zinc-500 mt-1">KING OF KINGS AND LORD OF LORDS.</p></div>
          <div className="border border-zinc-800 p-5 rounded-lg"><p className="text-xs font-bold">Colossians 1:20</p><p className="text-[11px] text-zinc-500 mt-1">...by making peace through his blood, shed on the cross.</p></div>
        </div>
