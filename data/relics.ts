// data/relics.ts
export type Relic = {  // <-- This line must have 'export'
  id: number;
  world: "armory" | "valley";
  title: string;
  songTitle: string;
...
export const RELICS: Relic[] = [
  ...
  },
  {
    ...
    verse: { text: "He restores my soul. He leads me in paths of righteousness.", ref: "Psalm 23:3" },
    declaration: "He doesn't just save you — He restores your soul."
  },
  {
    id: 6,
    world: "armory",
